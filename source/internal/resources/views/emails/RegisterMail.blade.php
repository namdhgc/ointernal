...
<table align="center" cellpadding="0" cellspacing="0" width="100%" height="100%">
  <tr>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
      <tr>
        <td style="background:#80ffaa" width="100%">

          <center>
            <table cellspacing="0" cellpadding="0" width="600" class="w320">
              <tr>
                <td valign="top" class="mobile-block mobile-no-padding-bottom mobile-center" width="270" style="background:#80ffaa;padding:10px 10px 10px 20px;">
                  <a href="http://insight-tec.com.vn/" style="text-decoration:none;">
                    <!-- <img src="http://insight-tec.com.vn/wp-content/uploads/2015/03/insight-tec-retina-logo.png" width="142" height="30" alt="Insight Technology Logo"/> -->
                    <img src="{{ URL::asset('image/logo.png') }}" width="142" height="30" alt="Insight Technology Logo"/>
                  </a>
                </td>
                <td valign="top" class="mobile-block mobile-center" width="270" style="background:#80ffaa;padding:10px 15px 10px 10px">
            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                  ...
                  <h2>Hello.</h2>
                  <h3>Welcome <b>{{ $data['firstname'] . ' ' . $data['lastname'] }}</b> to Insight Technology!</h3>
					<p>You just sign up with email address <b>{{ $data['email'] }}</b></p>
					<p>Your temporary password is <b>{{ $data['password'] }}</b>. </p>
					<p>Please change your password in the first time login.</p>
					<p>Thank you.</p>
					<p>Regards.</p>

                  <br>
                  We're excited you're here! Learn more about Insight Technology and activate your new account by clicking the link below!<br>
                  <br>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff">
                    <tr>
                      <td style="width:130px;background:#D84A38;">
                        ...
                        style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:130px;-webkit-text-size-adjust:none;">Log in!</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                          <![endif]-->
