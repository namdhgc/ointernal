                  ...
                  <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td style="text-align:center; font-size:30px; padding-bottom:20px;">
                        Your overtime request has been
                          {{ $data['isApproved'] == 2 ? 'reject' : '' }}
                          {{ $data['isApproved'] == 1 ? 'approved' : '' }}
                          {{ $data['isApproved'] == 0 ? 'not approved' : '' }}
                      </td>
                    </tr>
                    <tr>
                      <td style="padding-bottom:20px;">
                        Hello <b>{{ $data['employeeFullName'] }}</b>, <br>
                        <br>
                        We would like you to know that your overtime request has
                        <b>
                          {{ $data['isApproved'] == 2 ? 'reject' : '' }}
                          {{ $data['isApproved'] == 1 ? 'approved' : '' }}
                          {{ $data['isApproved'] == 0 ? 'not approved' : '' }}!
                        </b>
                        To view your overtime request or make any changes please contact to your Team leader or Human Resource Management.
                        <br>
                        <br>
                      </td>
                    </tr>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                      <!-- <td class="left" width="129" height="20" style="padding-top:10px; text-align:left;">
                        <img class="left" width="129" height="20" src="https://www.filepicker.io/api/file/2R9HpqboTPaB4NyF35xt" alt="Insight Technology">
                      </td> -->
                    </tr>
                  </table>
