                              ...
                              <tr>
                                <td align="center">
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td>
                                        <?php $link_route = 'reset-password'; ?>
                                        <a href="{{  URL::Route($link_route, ['email' => $data['email'], 'token' => $data['token'] ]) }}" class="button button--green" target="_blank">
                                          Reset your password
                                        </a>
                                      </td>
                                    </tr>
