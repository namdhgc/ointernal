                  ...
                  <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                      <td style="padding-bottom:20px;">
                        ...
                        <br>
                        We would like you to know that your leave request has
                        <b>
                          {{ $data['isApproved'] == 2 ? 'reject' : '' }}
                          {{ $data['isApproved'] == 1 ? 'approved' : '' }}
                          {{ $data['isApproved'] == 0 ? 'not approved' : '' }}!
                        </b>
                        To view your leave request or make any changes please contact to your Team leader or Human Resource Management.
                        <br>
                        <br>
                      </td>
                    </tr>
