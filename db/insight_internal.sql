...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2016 at 08:04 AM
...
CREATE TABLE `employee` (
  ...
  `probationary` datetime NOT NULL,
  `official_date` datetime NOT NULL,
  `out_date` datetime DEFAULT NULL,
  `position` smallint(6) NOT NULL,
  `managerId` int(11) DEFAULT NULL,
  `departmentId` int(11) NOT NULL,
  `diplomaId` smallint(6) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `description` varchar(1024) DEFAULT NULL,
  `avatar_name` varchar(64) NOT NULL,
  `avatar_path` varchar(256) NOT NULL,
...
CREATE TABLE `workingtime` (
  ...
  `note` varchar(1024) DEFAULT NULL,
  `totalTimePerDay` datetime NOT NULL,
  `totalTimePerMonth` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
